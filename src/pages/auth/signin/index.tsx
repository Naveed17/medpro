        ...
        <>
            {!session && (<Grid item xs={12} md={12}>
                <Box mt={-2}>
                    ...
                    <Box sx={{ height: '2px', backgroundColor: 'divider', mt: 5, mb: 8, width: '75%', mx: 'auto', position: 'relative', '& p': { position: 'absolute', px: 1.5, backgroundColor: theme.palette.background.default, left: '50%', color: theme => theme.palette.grey["A300"], transform: 'translateX(-50%)', top: -10 } }}>
                        <Typography>
                            {t('login.sign_divider')}
                        </Typography>
                    </Box>
                    <Box>
                        <TextField sx={{ background: theme => theme.palette.grey["A500"] }} fullWidth placeholder={t('login.sign_email_placeholder')} />
                        <TextField sx={{ background: theme => theme.palette.grey["A500"], mt: 1.2 }} fullWidth placeholder={t('login.sign_pass_placeholder')} />
