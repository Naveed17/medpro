                    ...
                    {(isMobile ? data.filter(item => item.id === open) : data).map((item, index) => (
                        <React.Fragment key={item.id}>
                            <ConsultationCard item={item} index={index} t={t} isMobile={isMobile}
                                              collapse={(v: boolean) => setCollapse(v)}>
                                {(item.id === 0) && (
                                    (collapse || isMobile) && (
                                        <Stack spacing={1} p={2}>
                                    ...
                                    <Box p={1.5}>
                                        <Grid container spacing={2}>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-text" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-soura" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-ordonance" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-traitement" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-analyse" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                            <Grid item xs={6} md={12}>
                                                <DocumentButton icon="ic-lettre" lable="Report" t={t}
                                                                handleOnClick={(v: string) => console.log(v)}/>
                                            </Grid>
                                        </Grid>
                                    </Box>
