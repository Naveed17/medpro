    ...
    return (
        <QuickAddAppointmentStyled>
            <CardHeader
                ...
                title={<Typography variant="h6" lineHeight={1}
                                   fontSize={18}>{t('add_appointment', {ns: "common"})}</Typography>}
                subheader={<Typography fontWeight={500} color={theme.palette.grey[500]}
                                       variant="subtitle2">{t('add-new-rdv', {ns: "common"})}</Typography>}
                action={
            ...
            {!finalize ?
                <Stack p={3}>
                    <Typography variant="subtitle2" fontSize={18}
                                fontWeight={600}>{t('filter.appointment')}</Typography>
                ...
                : <Stack p={3} spacing={2} maxWidth={380} m="auto">
                    ...
                    <Typography lineHeight={2.5} textAlign='center' variant="subtitle2" color="grey.400"
                                component="div">{t('steppers.final-step.rdv-for')} {" "}
                        <Label color="primary" sx={{ml: 1}}>
                            <Stack direction='row' component={'span'} alignItems='center' spacing={.5}>
                                <IconUrl color={theme.palette.primary.main} width={16} height={16}
                                         path="ic-filled-user-id"/>
                        ...
                        <Typography component='div' variant="subtitle2">
                            ...
                            <Label color="success" sx={{mx: 1}}>
                                <Stack direction='row' component={'span'} alignItems='center' spacing={.5}>
                                    <IconUrl color={theme.palette.success.main} width={16} height={16}
                                             path="ic-filled-calendar-tick"/>
                    ...
                    <Button startIcon={<IconUrl color={theme.palette.primary.main} width={16} height={16}
                                                path="ic-outline-user-id"/>} variant="outlined">
