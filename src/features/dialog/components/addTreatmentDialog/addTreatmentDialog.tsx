import {Autocomplete, Box, Card, CardContent, IconButton, Stack, TextField, Typography} from '@mui/material'
...
function AddTreatmentDialog({...props}) {
    ...
    const addTraitment = (event:any, newValue:any) => {
        ...
        data.setState([...data.state, {uuid: selectedDrug.uuid, name: selectedDrug.commercial_name, isVerified: selectedDrug.isVerified}])
        setDrug("");
    }
