export const countries = [
    {code: "TN", name: "Tunisia", phone: "+216", suggested: true},
    {code: "DZ", name: "Algeria", phone: "+213", suggested: true},
    {code: "LY", name: "Libya", phone: "+218", suggested: true},
    {code: "MA", name: "Maroc", phone: "+212", suggested: true},
    {code: "NG", name: "Nigeria", phone: "+234", suggested: true},
    {code: "CI", name: "Cote d'Ivoire", phone: "+225", suggested: true},
    {code: "ML", name: "Mali", phone: "+223", suggested: true},
    {code: "IT", name: "Italy", phone: "+39", suggested: true},
    {code: "DE", name: "Germany", phone: "+49", suggested: true},
    {code: "CH", name: "Switzerland", phone: "+41", suggested: true},
    {code: "FR", name: "France", phone: "+33", suggested: true},
    {code: "ES", name: "Spain", phone: "+34", suggested: true},
    {code: "BE", name: "Belgium", phone: "+32", suggested: true},
    {code: "BF", name: "Burkina Faso", phone: "+226", suggested: true},
    {code: "CF", name: "Central African Republic", phone: "+236", suggested: true},
    {code: "CG", name: "Congo, Republic of the", phone: "+242", suggested: true},
    {code: "CM", name: "Cameroon", phone: "+237", suggested: true},
    {code: "GA", name: "Gabon", phone: "+241", suggested: true},
    {code: "GH", name: "Ghana", phone: "+233", suggested: true},
    {code: "KE", name: "Kenya", phone: "+254", suggested: true},
