                ...
                <Box>
                    <CardContent>
                        <Stack
                            ...
                            pb={1.2}
                            mb={1.2}>
                            <Typography fontWeight={600} variant="subtitle2" fontSize={18}>{t("transactions")}</Typography>
                            ...
                            <Stack spacing={1}>
                                {rows.map((row: any, idx: number) =>
                                    <Card sx={{ boxShadow: 'none', border: 1, borderColor: "divider" }}>
                                        <CardContent>
                                            <Stack direction='row' flexWrap={{ xs: 'wrap', sm: 'nowrap' }} alignItems='flex-start' justifyContent='space-between' spacing={{ xs: 0, sm: 1 }}>
                                                <Stack sx={{ width: { xs: '50%', sm: 'auto' } }}>
                                                    <Typography gutterBottom variant="caption" color="text.secondary">{t("date_time", { ns: 'payment' })}</Typography>
                                                    <Stack direction={{ xs: 'column', sm: 'row' }} alignItems={{ xs: 'flex-start', sm: 'center' }} spacing={.5}>
                                                ...
                                                <Stack sx={{ width: { xs: '50%', sm: 'auto' } }}>
                                                    <Typography gutterBottom variant="caption" color="text.secondary">{t("payment_method")}</Typography>
                                                    <Stack
                                                        direction="row"
                                                        alignItems="center"
                                                        spacing={1}>
                                                        {row.payment_means && row.payment_means.length ?
                                                            row.payment_means.map((mean: any) => (
                                                                <Tooltip
                                                                    key={mean.slug}
                                                                    title={`${mean.amount} ${devise}`}>
                                                                    <CustomIconButton size="small" color="primary" sx={{ p: 1, bgcolor: theme.palette.primary.lighter }}>
                                                                        <img
                                                                            style={{ width: 15 }}
                                                                            key={mean.slug}
                                                                            src={
                                                ...
                                                <Stack sx={{ width: { xs: '50%', sm: 'auto' } }}>
                                                    <Typography gutterBottom variant="caption" color="text.secondary">{t("used")}</Typography>
                                                    <Typography fontWeight={500}>
                                                        {row.amount - row.rest_amount} {devise}
                                                    </Typography>
                                                ...
                                                <Stack sx={{ width: { xs: '50%', sm: 'auto' } }}>
                                                    <Typography gutterBottom variant="caption" color="text.secondary">{t("amount")}</Typography>
                                                    <Typography fontWeight={500}>
                                                        {row.amount} {devise}
                                                    </Typography>
