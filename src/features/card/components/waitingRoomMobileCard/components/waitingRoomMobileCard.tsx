...
const [counter,setCounter] = useState<number>(0)
    ...
    return (
            ...
            <Card sx={{width: '100%', 
             ...
             bgcolor:[3].includes(quote.status) ? alpha(theme.palette.warning.lighter,.7):theme.palette.common.white}}>
                            ...
                            <Typography variant="body2" overflow='hidden'>
                                {quote.status === 4 && time ?
                                    ...
                                    quote.status !== 3 ?
                                        ...
                                        {
                                            getDiffDuration(`${quote.dayDate} ${quote.startTime}`).split(",")[0]

                                        }
                                        <IconUrl path={'ic-waiting-hours'} width={12} height={12} style={{margin:"0 4px"}}/>
                                        {getDiffDuration(`${quote.dayDate} ${quote.startTime}`).split(",")[1]}
                                        </Stack>}
                            </Typography>
                        </Stack>
